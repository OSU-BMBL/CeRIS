...
do
	...
	#nohup /var/www/html/iris3/program/meme/bin/tomtom  -no-ssc -oc tomtom/$(basename "$file" .fsa.meme)/ -verbosity 1 -min-overlap 5 -mi 1 -dist pearson -evalue -thresh 10.0 $file /var/www/html/iris3/program/motif_databases/EUKARYOTE/jolma2013.meme /var/www/html/iris3/program/motif_databases/JASPAR/JASPAR2018_CORE_vertebrates_non-redundant.meme /var/www/html/iris3/program/motif_databases/MOUSE/uniprobe_mouse.meme &
	#TOMTOM human&mouse 
