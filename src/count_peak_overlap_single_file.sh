...
atac_summary=/home/www/html/iris3/program/human_atac_seq/human_atac_data.txt
fi
if [ "$species" == "Mouse" ]; then
atac_dir=/home/www/html/iris3/program/mouse_atac_seq
atac_summary=/home/www/html/iris3/program/mouse_atac_seq/mouse_atac_data.txt
fi
