...
while read -r species; do 
	...
	do
		...
		if [ "$is_meme" == "1" ]; then
			...
			/var/www/html/iris3/program/meme/bin/meme $file -nostatus -w 12 -allw -mod anr -revcomp -nmotifs 10 -objfun de -neg /var/www/html/iris3/program/bg_data/Human.bg.fa -dna -text > $ct_dir"/bic"$meme_index.txt.fa.closures &
