...
dir=$1
mkdir tomtom
perl /var/www/html/CeRIS/program/dminda/motif_tools/bobro2align.pl $dir
...
do
	...
	perl /var/www/html/CeRIS/program/dminda/motif_tools/split_multifasta.pl -i $file -o $dir\/logo &
done
wait
