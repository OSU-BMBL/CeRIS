...
#	header("Location: warning.php");
	...
	if ($species_arg[0] == "Zebrafish" || $species_arg[0] == "Fruit_fly" ||$species_arg[0] == "Worm" ||$species_arg[0] == "Yeast" ) {
		if ($labelfile != ''){
fwrite($fp,"#!/bin/bash\n 
#User uploaded cell label, 4 species
...
Rscript /home/www/html/iris3/program/genefilter_test.R \$wd\$exp_file \$jobid $delim $is_gene_filter $is_cell_filter
...
Rscript /home/www/html/iris3/program/cvt_symbol_test.R \$wd \$wd\$jobid\_filtered_expression.txt \$jobid $promoter_arg\n 
...
Rscript /home/www/html/iris3/program/prepare_bbc_test.R \$wd $motif_program \$motif_min_length\n
touch bg \n
...
cd \$wd\n
find -name '*' -size 0 -delete\n
Rscript /home/www/html/iris3/program/prepare_bbc_test.R \$wd $motif_program\n
touch bg \n
/home/www/html/iris3/program/get_bbc.sh \$wd\n
