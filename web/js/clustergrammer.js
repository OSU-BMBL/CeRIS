...
/***/ (function(module, exports) {
	...
	module.exports = function set_defaults() {
	  ...
	  var defaults = {
	    ...
	    cat_value_colors: ['#31dc89', '#9370DB'],
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function set_up_filters(cgm, filter_type) {
	  ...
	  //var div_filters = d3.select(params.root + ' .sidebar_wrapper').append('div').classed('div_filters', true).style('display', 'none').style('padding-right', '10px');
var div_filters = d3.select(params.root + ' .sidebar_wrapper').append('div').classed('div_filters', true).style('padding-left', '10px').style('padding-right', '10px').style('display', 'none');
...
*/
	  row.append('div').classed('clust_icon', true).style('float', 'left').style('width', width_pct).style('padding-left', padding_left).style('padding-right', padding_right).append('i').classed('fa', true).classed('fa fa-cloud-download', true).classed('icon_buttons', true).style('font-size', '25px').on('click', function () {
	    ...
	    cgm.save_matrix();
	  }).classed('sidebar_tooltip', true).append('span').classed('sidebar_tooltip_text', true).html('Download matrix').style('left', '100%');
...
/***/ (function(module, exports) {
	...
	module.exports = function set_up_opacity_slider(sidebar) {
	  ...
	  var slider_container = sidebar.append('div').classed('opacity_slider_container', true).style('display', 'none').style('padding-left', '10px').style('padding-right', '10px');
