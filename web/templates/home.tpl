                        ...
                        <div class="row flex-v-center">
                            <div class="col-md-7 col-lg-7 col-sm-7 col-xs-7">
                                <div class="welcome-text">
                                    <h1>IRIS3</h1>
                                    <p>Integrated Cell-type-specific Regulon Inference Server from Single-cell RNA-Seq</p>
							 ...
							 <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
                                <div class="welcome-text">
                                 <a href="assets/img/iris3_pipeline.png" target="_blank"><img src="assets/img/iris3_pipeline.png" style="height:500px;margin:auto;display:block"></a>
